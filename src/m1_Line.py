...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.start_original = start.clone()
        self.end_original = end.clone()
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        line_plus=Line(self.start.plus(other_line.start),self.end.plus(other_line.end))
        return line_plus
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        line_minus = Line(self.start.minus(other_line.start), self.end.minus(other_line.end))
        return line_minus
