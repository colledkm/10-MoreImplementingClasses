    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        lower_corner_h = rg.Point(intersection_center.x + width * 0.5, intersection_center.y + letter_thickness * 0.5)
        upper_corner_h = rg.Point(intersection_center.x - width*0.5 , intersection_center.y - letter_thickness*0.5)
        lower_corner_v = rg.Point(intersection_center.x + letter_thickness * 0.5,intersection_center.y - letter_thickness * 0.5)
        upper_corner_v = rg.Point(intersection_center.x - letter_thickness*0.5,intersection_center.y - letter_thickness * 0.5 + height)
        self.h_rect = rg.Rectangle(upper_corner_h,lower_corner_h)
        self.v_rect = rg.Rectangle(upper_corner_v,lower_corner_v)
